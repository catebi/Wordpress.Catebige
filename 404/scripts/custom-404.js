document.addEventListener("DOMContentLoaded", function() {
    ...
    const configs = [
        {
            ...
            imageSize: { width: 'auto', height: '80%' },
    ...
    container.innerHTML = `
        ...
        <p style="position: absolute; top: ${config.description.position.top}; left: ${config.description.position.left}; transform: ${config.title.position.transform};">${description}</p>
